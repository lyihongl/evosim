...
public:
  ...
  omni_sight(int w, int h, std::size_t render_layers)
      : layers(3), render_targets(render_layers), screen_dat(render_layers) {
  ...
  const sf::Color &get_color_from_buff(const std::size_t buffer,
